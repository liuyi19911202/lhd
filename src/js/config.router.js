    ...
    function routerConfig($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('app.product.list', {
                url: '/list',
                templateUrl: 'tpl/custom/product/product-list.html',
                controller: 'ProductListCtrl',
                resolve: {
                    deps: ['uiLoad',
                        function (uiLoad) {
                            return uiLoad.load(['js/custom/product/product-list.js',
                                'js/custom/product/product-service.js'
                            ]);
                        }]
                }
            })
            .state('app.product.form', {
                url: '/form/{id}',
                templateUrl: 'tpl/custom/product/product-form.html',
                controller: 'ProductFormCtrl',
                resolve: {
                    deps: ['uiLoad',
                        function (uiLoad) {
                            return uiLoad.load(['js/custom/product/product-form.js',
                                'js/custom/product/product-service.js'
                            ]);
                        }]
                }
            })
            .state('app.product.webmagic', {
                url: '/webmagic',
                templateUrl: 'tpl/custom/product/product-webmagic.html',
                controller: 'ProductMagicCtrl',
                resolve: {
                    deps: ['uiLoad',
                        function (uiLoad) {
                            return uiLoad.load(['js/custom/product/product-webmagic.js',
                                'js/custom/product/product-webmagic-service.js'
                            ]);
                        }]
                }
            })
